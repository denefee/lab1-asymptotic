...
plt.title(r'График зависимости времени работы Стратегии A при неравномерном распределении запросов (равномерен по массиву, но не включает все его значения)', fontsize=14)
plt.grid(True)
